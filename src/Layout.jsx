...
export function Layout() {
  ...
  return (
    <Authenticator className="items-center">
      <>
        <div className="min-h-screen grid grid-col-1 lg:grid-cols-6 bg-slate-100 scrollbar-hide">
          {/*Sidebar*/}
          <aside
            className={`fixed top-0 w-[80%] md:w-[40%] lg:w-full z-50   bg-white  ${
              sidebar ? " sticky left-0" : "-left-full sticky"
            } h-full col-span-1 p-6 border-r `}
          >
            {/*LogoTipo*/}
              ...
              <nav>
                <ul>
                  <li>
                    <Link
                      to="/conductor"
                      className="flex items-center gap-4 text-gray-700 hover:bg-gray-900 p-4 hover:text-white rounded-sm
            transition-colors font-semibold"
                  ...
                  <li>
                    <Link
                      to="/incidencias"
                      className="flex items-center gap-4 text-gray-700 hover:bg-gray-900 p-4 hover:text-white 
            ...
            transition-colors font-semibold rounded-sm"
              ...
              <div className="flex flex-col gap-4">
                ...
                <Link
                  onClick={signOut}
                  className="flex items-center gap-4 text-gray-700 hover:bg-gray-800 p-3 hover:text-white 
            transition-colors font-semibold rounded-sm  "
                >
                  <RiDashboard2Line />
                  Cerrar sesion
          ...
          <div className="col-span-5">
            {/* Navbar */}
            <nav className=" sticky border-r top-0 z-10 bg-white flex flex-col md:flex-row gap-4 items-center justify-between p-4 md:px-8 lg:px-12 w-full  ">
              {/* Search */}
